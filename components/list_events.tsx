    ...
    return (
        <div className="flex flex-wrap justify-center">
            {events.map((event, index) => (
                <div key={index} className="m-4 bg-white shadow-lg rounded-lg overflow-hidden cursor-pointer" style={{ width: "300px" }}>
                    ...
                    <div className="p-4">
                        ...
                        <div className="flex justify-center gap-3 items-center mx-2">
